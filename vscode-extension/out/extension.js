...
function decorate(report) {
    ...
    const ranges = { verified: [], needs_support: [], review_needed: [], decision_recorded: [], untestable: [] };
...
function evidenceHtml(claimId, e) {
    ...
    const decideBtns = Object.keys(ACTIONS).map((k) => `<button class="act ${ACTIONS[k].cls}" ${data} data-decision="${ACTIONS[k].decision}"` +
